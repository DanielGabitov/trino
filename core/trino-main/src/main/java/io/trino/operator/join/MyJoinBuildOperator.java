...
public class MyJoinBuildOperator
        implements Operator
{
    public static class MyJoinBuildOperatorFactory
            implements OperatorFactory
    {
        ...
        public MyJoinBuildOperatorFactory(int operatorId, PlanNodeId planNodeId, JoinBridgeManager<NestedLoopJoinBridge> nestedLoopJoinBridgeManager)
        {
        ...
        {
            return new MyJoinBuildOperatorFactory(operatorId, planNodeId, nestedLoopJoinBridgeManager);
        }
    }
    ...
    public MyJoinBuildOperator(OperatorContext operatorContext, NestedLoopJoinBridge nestedLoopJoinBridge)
    {
